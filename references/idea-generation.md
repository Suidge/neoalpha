...
评分解释以 preset 为准：
- `short_term_momentum`：`70+` Strong Watch，`58-70` Setup Watch，`45-58` Theme Lead，`<45` Avoid Chase。
- `long_term_compounder`：`76+` Thesis Candidate，`66-76` DCF Candidate，`52-66` Watchlist Only，`<52` Reject。
